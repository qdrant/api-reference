async fn main() -> Result<(), qdrant_client::QdrantError> {
    ...
    use qdrant_client::qdrant::RecommendInputBuilder;
    use qdrant_client::qdrant::{PointId, PrefetchQueryBuilder, Query, QueryPointsBuilder};
    ...
    client
        .query(
            QueryPointsBuilder::new("{collection_name}").query(Query::new_nearest(PointId::from(
